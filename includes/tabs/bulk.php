    <div id="bulk" class="tab-content">
        ...
        <div
            style="background: linear-gradient(135deg, var(--gradient-pink-start) 0%, var(--gradient-pink-end) 100%); padding: 20px; border-radius: 12px; margin-bottom: 25px; color: var(--text-on-accent);">
            <h3 style="color: var(--text-on-accent); margin-bottom: 20px;">🔧 Field Operations</h3>
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 15px;">
                <!-- Add Field -->
                <div style="background: var(--card-bg); padding: 18px; border-radius: 8px; color: var(--text-primary);">
                    <h4 style="color: var(--accent-success); margin-bottom: 12px;">➕ Add Field</h4>
                    <form method="POST">
                        ...
                        <button type="submit" class="btn"
                            style="background: var(--accent-success); color: var(--text-on-accent); width: 100%; padding: 10px; font-size: 14px;">➕
                            Add to All</button>
                    </form>
                </div>
                ...
                <!-- Remove Field -->
                <div style="background: var(--card-bg); padding: 18px; border-radius: 8px; color: var(--text-primary);">
                    <h4 style="color: var(--accent-danger); margin-bottom: 12px;">❌ Remove Field</h4>
                    <form method="POST" onsubmit="return confirm('Remove this field from ALL documents?')">
                        ...
                        <input type="text" name="field_name" placeholder="Field name" required
                            style="width: 100%; padding: 8px; border: 2px solid var(--border-color); border-radius: 4px; margin-bottom: 8px;">
                        <button type="submit" class="btn"
                            style="background: var(--accent-danger); color: var(--text-on-accent); width: 100%; padding: 10px; font-size: 14px;">❌
                ...
                <!-- Rename Field -->
                <div style="background: var(--card-bg); padding: 18px; border-radius: 8px; color: var(--text-primary);">
                    <h4 style="color: var(--accent-warning); margin-bottom: 12px;">✏️ Rename Field</h4>
                    <form method="POST">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 25px;">
            <div style="background: var(--card-bg); padding: 20px; border-radius: 8px; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
                <h3>🔄 Bulk Update</h3>
                <form method="POST">
                    ...
                    <button type="submit" class="btn"
                        style="background: var(--accent-warning); color: var(--text-primary); width: 100%; padding: 12px;"
            ...
            <div style="background: var(--card-bg); padding: 20px; border-radius: 8px; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
                ...
                <form method="POST">
                    ...
                    <button type="submit" class="btn"
                        style="background: var(--accent-info); color: var(--text-on-accent); width: 100%; padding: 12px;"
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px;">
            <!-- Deduplication -->
            <div style="background: var(--card-bg); padding: 20px; border-radius: 8px; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
                <h3 style="color: var(--accent-info);">🧹 Remove Duplicates</h3>
                <form method="POST" onsubmit="return confirm('This will remove duplicate documents. Continue?')">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="dedup_field" placeholder="e.g., email" required
                            style="width: 100%; padding: 10px; border: 2px solid var(--border-color); border-radius: 6px;">
                        <small style="color: var(--text-secondary);">Keeps first occurrence, removes rest</small>
                    </div>
                    <button type="submit" class="btn"
                        style="background: var(--accent-info); color: var(--text-on-accent); width: 100%; padding: 12px;">🧹 Deduplicate</button>
                </form>
            </div>

            <!-- Bulk Delete by Field -->
            <div style="background: var(--card-bg); padding: 20px; border-radius: 8px; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
                <h3 style="color: var(--accent-danger);">🗑️ Bulk Delete by Field</h3>
                <form method="POST" onsubmit="return confirm('This will permanently delete documents. Are you sure?')">
                    ...
                    <button type="submit" class="btn"
                        style="background: var(--accent-danger); color: var(--text-on-accent); width: 100%; padding: 12px;">🗑️ Delete
                        Matching</button>
                </form>
            </div>
            ...
            <!-- Data Generator -->
            <div style="background: var(--card-bg); padding: 20px; border-radius: 8px; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
                <h3 style="color: var(--accent-success);">🎲 Generate Test Data</h3>
                <form method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="data_template"
                            ...
                            required
                            style="width: 100%; padding: 10px; border: 2px solid var(--border-color); border-radius: 6px; min-height: 100px; font-family: monospace; font-size: 12px;"></textarea>
                        <small style="color: var(--text-secondary);">Placeholders: {{index}}, {{random}}, {{date}}, {{timestamp}}</small>
                    </div>
                    <div class="form-group">
                    ...
                    <button type="submit" class="btn"
                        style="background: var(--accent-success); color: var(--text-on-accent); width: 100%; padding: 12px;">🎲 Generate &
                        Insert</button>
                </form>
            </div>
        </div>
